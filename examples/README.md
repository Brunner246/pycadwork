...
| [`collision.py`](collision.py) | `check_collisions` for overlap / contact / near-miss / clearance, `exclude=` type filtering, the pairwise predicates, the `GEOMETRY` backend, `highlight_clashes`, and CSV export |
